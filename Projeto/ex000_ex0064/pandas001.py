...
# simples com poucas colunas (ide, nome,telefone) Imprimindo todo o conteúdo
# exemplo = 1 
# exemplo = 2  # Simples com poucas colunas (id, nome, telefone)
exemplo = 3  # diversas colunas, e com calculo de media das colunas n1,n2,n3,n4
# Além de mostrar as médias, cria um dicionario de dados das medias
...
if (exemplo == 3):
    ...
    # Aqui especificamos quais são as colunas que desejamos obter a média:
    ...
    # {'Nome': 'Adriano', 'Idade': 47, 'Telefone': 67992636781, 'CEP': 89010230, 'N1': '10,20', 'N2': '7,50', 'N3': '3,20', 'N4': '10,20'}

    for i in dd.values():
        # print(i) #bloqueado pra não poluir
        # Imprime um cabeçalho na esquerda de cada linha. (i)
        print(":", end=' ')

        # Desdobramento de i, para impressão apenas dos valores:
        # Para isto vamos usar a variável colunas, definida acima
